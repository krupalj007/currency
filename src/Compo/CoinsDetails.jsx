...
<HStack p={'4'} overflowX={'auto'}>  
{
  ...
  {/* const currencySymbol = currency ==='inr'?'₹' : currency === 'eur'?'€' : '$'; */}
    <Radio value={'inr'} overflow={'hidden'} spacing={'2'}>₹ INR</Radio>
    <Radio value={'usd'} overflow={'hidden'} spacing={'2'}>$ USD</Radio>
    <Radio value={'eur'} overflow={'hidden'} spacing={'2'}>€ EUR</Radio>
...
const Item = ({title,value}) => (
  <HStack justifyContent={'space-between'} my={'4'} w={'full'}>
    <Text letterSpacing={'widest'} fontFamily={'cursive'}><b>{title}</b></Text>
    <Text>{value}</Text>
  </HStack>
)
...
<Text fontSize={'sm'} fontFamily={'cursive'}>24H Range</Text>
